...
func init(){
	...
	eCountEdgeBytes.key = []byte{21, 18, 2, 99, 0, 2, 101, 0, 1, 0, 255, 100, 0, 2, 49, 69, 115, 74, 52, 79, 119, 79, 65, 100, 121, 119, 103, 56, 105, 77, 51, 100, 110, 72, 50, 79, 68, 72, 102, 106, 113, 0, 1, 0, 255, 10, 0, 2, 49, 69, 115, 74, 52, 79, 52, 70, 108, 74, 88, 109, 75, 100, 78, 120, 76, 107, 53, 50, 71, 111, 52, 120, 48, 117, 69, 0, 2, 97, 0}
	eCountEdgeBytes.start = []byte{21, 18, 2, 99, 0, 2, 101, 0, 1, 0, 255, 100, 0, 2, 49, 69, 115, 74, 52, 79, 119, 79, 65, 100, 121, 119, 103, 56, 105, 77, 51, 100, 110, 72, 50, 79, 68, 72, 102, 106, 113, 0, 1, 0, 255, 10, 0, 2, 49, 69, 115, 74, 52, 79, 52, 70, 108, 74, 88, 109, 75, 100, 78, 120, 76, 107, 53, 50, 71, 111, 52, 120, 48, 117, 69, 0, 2, 48, 0}
	eCountEdgeBytes.end = []byte{21, 18, 2, 99, 0, 2, 101, 0, 1, 0, 255, 100, 0, 2, 49, 69, 115, 74, 52, 79, 119, 79, 65, 100, 121, 119, 103, 56, 105, 77, 51, 100, 110, 72, 50, 79, 68, 72, 102, 106, 113, 0, 1, 0, 255, 10, 0, 2, 49, 69, 115, 74, 52, 79, 52, 70, 108, 74, 88, 109, 75, 100, 78, 120, 76, 107, 53, 50, 71, 111, 52, 120, 48, 117, 69, 0, 2, 102, 0}

	// IRI: c/n/100/1EsJ4OwOAdywg8iM3dnH2ODHfjq
	eCountNodeBytes.key = []byte{21, 18, 2, 99, 0, 2, 110, 0, 1, 0, 255, 100, 0, 2, 49, 69, 115, 74, 52, 79, 119, 79, 65, 100, 121, 119, 103, 56, 105, 77, 51, 100, 110, 72, 50, 79, 68, 72, 102, 106, 113, 0, 2, 97, 0}
	eCountNodeBytes.start = []byte{21, 18, 2, 99, 0, 2, 110, 0, 1, 0, 255, 100, 0, 2, 49, 69, 115, 74, 52, 79, 119, 79, 65, 100, 121, 119, 103, 56, 105, 77, 51, 100, 110, 72, 50, 79, 68, 72, 102, 106, 113, 0, 2, 48, 0}
	eCountNodeBytes.end = []byte{21, 18, 2, 99, 0, 2, 110, 0, 1, 0, 255, 100, 0, 2, 49, 69, 115, 74, 52, 79, 119, 79, 65, 100, 121, 119, 103, 56, 105, 77, 51, 100, 110, 72, 50, 79, 68, 72, 102, 106, 113, 0, 2, 102, 0}
}
...
func TestIRICounterEdgeCompose(t *testing.T) {
	...
	x.bytes([]byte(c1.GetKey(testDb.DbCount, "a")), eCountEdgeBytes.key, "GetKey()")

	rStart, rEnd := c1.GetKeyRange(testDb.DbCount).FDBRangeKeys()
	x.bytes([]byte(rStart.FDBKey()), eCountEdgeBytes.start, "GetKeyRange(start)")
	x.bytes([]byte(rEnd.FDBKey()), eCountEdgeBytes.end, "GetKeyRange(end)")
}
...
func TestIRICounterEdgeParse(t *testing.T) {
	...
	x.bytes([]byte(c2.GetKey(testDb.DbCount, "a")), eCountEdgeBytes.key, "GetKey()")
...
func TestIRICounterNodeCompose(t *testing.T) {
	...
	x.bytes([]byte(c3.GetKey(testDb.DbCount, "a")), eCountNodeBytes.key, "GetKey()")

	rStart, rEnd := c3.GetKeyRange(testDb.DbCount).FDBRangeKeys()
	x.bytes([]byte(rStart.FDBKey()), eCountNodeBytes.start, "GetKeyRange(start)")
	x.bytes([]byte(rEnd.FDBKey()), eCountNodeBytes.end, "GetKeyRange(end)")
}
...
func TestIRICounterNodeParse(t *testing.T) {
	...
	x.bytes([]byte(c4.GetKey(testDb.DbCount, "a")), eCountNodeBytes.key, "GetKey()")
